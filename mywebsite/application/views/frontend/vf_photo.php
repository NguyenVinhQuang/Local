<link rel="stylesheet" href="<?php echo base_url(); ?>resources/css/style_photo.css">
<script src="<?php echo base_url(); ?>resources/scripts/event_photo.js" type="text/javascript"></script>
<div id="all-photo">
	<div id="photo-details-header">
	    <div id="photo-details-header-actions">
	    	<a href="<?php echo base_url(); ?>index.php/upload/displayUpload/<?php echo $place['id']; ?>">Add photos</a>
	    </div>
	    <h2>
	...
	<div class="photos-index unselectable" id="content-all">
